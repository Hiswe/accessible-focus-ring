...
},{}],"esmodule-example.ts":[function(require,module,exports) {
"use strict";
...
var focus_ring_1 = __importDefault(require("../dist/focus-ring"));

var on_tab_1 = __importDefault(require("./on-tab"));

focus_ring_1["default"]({
  "class": 'no-ring',
  onTab: on_tab_1["default"]
});
},{"../dist/focus-ring":"../dist/focus-ring.js","./on-tab":"on-tab.js"}]},{},["esmodule-example.ts"], null)